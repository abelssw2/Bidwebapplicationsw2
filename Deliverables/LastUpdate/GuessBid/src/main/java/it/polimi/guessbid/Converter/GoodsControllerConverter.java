 ...
 */
package it.polimi.guessbid.Converter;

import it.polimi.guessbid.Bean.GoodsController;
...
@FacesConverter(forClass = Goods.class)
    public class GoodsControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Goods) {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Goods.class.getName()});
                return null;
            }
        }
