...
public class AuthFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
         try {
            ...
            if ( reqURI.contains("/Login.xhtml") || reqURI.contains("/accountTempl.xhtml")||reqURI.contains("/useraccount/Create.xhtml")||(ses != null && ses.getAttribute("username") != null)
                                       || reqURI.contains("/public/") || reqURI.contains("javax.faces.resource") )
            {
                     req.getSession().setAttribute("requestedPage", req.getRequestURI());
