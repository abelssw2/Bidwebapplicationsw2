...
public class PaymentController implements Serializable {
    ...
    @EJB private it.polimi.guessbid.Controler.PaymentFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/bid").getString("PaymentCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/bid").getString("PaymentUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/bid").getString("PaymentDeleted"));
        if (!JsfUtil.isValidationFailed()) {
