...
public class SellerController implements Serializable {
    ...
    @EJB private it.polimi.guessbid.Controler.SellerFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/bid").getString("SellerCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/bid").getString("SellerUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/bid").getString("SellerDeleted"));
        if (!JsfUtil.isValidationFailed()) {
